...
title = Label(entries_frame, text="Insurance Management System", font=("Calibri", 18, "bold"), bg="#535c68", fg="white")
...
btn_frame.grid(row=6, column=0, columnspan=4, padx=10, pady=10, sticky="nesw")
btnAdd = Button(btn_frame, command=add_employee, text="Add Details", width=20, font=("Calibri", 16, "bold"), fg="white",
                bg="#16a085", bd=0).grid(row=0, column=0)
btnEdit = Button(btn_frame, command=update_employee, text="Update Details", width=20, font=("Calibri", 16, "bold"),
                 fg="white", bg="#2980b9",
                 bd=0).grid(row=0, column=1, padx=10)
btnDelete = Button(btn_frame, command=delete_employee, text="Delete Details", width=20, font=("Calibri", 16, "bold"),
                   fg="white", bg="#c0392b",
